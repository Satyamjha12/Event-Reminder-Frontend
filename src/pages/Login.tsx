...
function Login() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-blue-600 via-cyan-500 to-teal-400 flex items-center justify-center px-4 relative overflow-hidden">
      {/* Animated Background Elements */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-0 right-0 w-96 h-96 bg-white/10 rounded-full blur-3xl animate-float"></div>
        <div className="absolute bottom-0 left-0 w-96 h-96 bg-cyan-300/10 rounded-full blur-3xl animate-float" style={{ animationDelay: '1.5s' }}></div>
      </div>
      ...
      >
        <div className="text-center mb-6">
          ...
          <h1 className="text-3xl font-bold text-white mb-1 text-shadow">Welcome Back</h1>
